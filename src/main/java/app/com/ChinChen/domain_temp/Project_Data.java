...
import app.com.ChinChen.domain.*;
import lombok.Data;
...
public class Project_Data {
    ...
    List<ChangePrice> changePriceList;//變更契約金額列表

    long calendarDay;//日曆天
    long cumulativeDay;//累計工期
    long remainingDay;//剩餘工期
    int changePrice;//更變更後契約金額
}
